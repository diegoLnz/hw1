            ...
            <div class="post-header">
                <div class="user-info">
                    ...
                    <div class="main-username">
                        <a id="userlink" href="#">generic_username1</a>
                    </div>
                </div>
        ...
        <div class="single-post">
            ...
            <div class="post-header">
                <div class="user-info">
                    <div class="user-image"></div>
                    <div class="main-username">
                        <a id="userlink" href="#">generic_username2</a>
                    </div>
                </div>
                <div class="actions-and-date">
                    <p class="upload-date">9 m</p>
            ...
            <div class="post-content">
                <p class="post-text">Qualcuno sa darmi una mano? Non capisco quale sia il problema...</p>
                <div class="post-image">
                    <img src="images/Posts/screen-code-coding-programming.jpg">
                </div>
                <div class="actions-menu">
                    <div class="action-item">
                        <svg class="action-icon" xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" viewBox="0 0 16 16">
        ...
        <div class="single-post">
            ...
            <div class="post-header">
                <div class="user-info">
                    <div class="user-image"></div>
                    <div class="main-username">
                        <a id="userlink" href="#">generic_username3</a>
                    </div>
                </div>
                <div class="actions-and-date">
                    <p class="upload-date">9 m</p>
            ...
            <div class="post-content">
                <p class="post-text">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Iste eveniet dolorem labore tempore laboriosam natus alias possimus odio necessitatibus soluta, dolor aut! Repellat, eum provident exercitationem iure iste animi porro.</p>
                <div class="actions-menu">
                    <div class="action-item">
                        <svg class="action-icon" xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" viewBox="0 0 16 16">
                            <path d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
        ...
        <div class="single-post">
            ...
            <div class="post-header">
                <div class="user-info">
                    <div class="user-image"></div>
                    <div class="main-username">
                        <a id="userlink" href="#">generic_username4</a>
                    </div>
                </div>
                <div class="actions-and-date">
                    <p class="upload-date">9 m</p>
            ...
            <div class="post-content">
                <p class="post-text">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Recusandae, beatae? Sapiente odit est omnis voluptatem quasi quis?</p>
                <div class="post-image">
                    <img src="images/Posts/vertical-post.jpg">
                </div>
                <div class="actions-menu">
                    <div class="action-item">
                        <svg class="action-icon" xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" viewBox="0 0 16 16">
        ...
        <div class="single-post">
            ...
            <div class="post-header">
                <div class="user-info">
                    <div class="user-image"></div>
                    <div class="main-username">
                        <a id="userlink" href="#">generic_username5</a>
                    </div>
                </div>
                <div class="actions-and-date">
                    <p class="upload-date">9 m</p>
